  ...
  return (
    <>
      ...
      <div className="rnd1bg">
        <div className="rnd1title" style={{ color: "white" }}>
          SureShot Livestream
        </div>
        ...
        <div className="rnd1head">
          <img className="rnd1img" src="./title.png" alt="" srcset="" />
        </div>
        <div
          style={{
            display: "flex",
        ...
        >
          <div
            className="rnd1btnrow"
            style={{ backgroundColor: "grey", border: "2px solid #5A5A5A" }}
          >
            Balloon 1
          </div>
          <div
            className="rnd1btnrow"
            style={{ backgroundColor: "red", border: "2px solid #8B0000" }}
          >
            Balloon 2
          </div>
        </div>
        ...
        >
          <div
            className="rnd1btnrow"
            style={{ backgroundColor: "#c03a7a", border: "2px solid #d03a7a" }}
          >
            Balloon 3
          </div>
          <div
            className="rnd1btnrow"
            style={{ backgroundColor: "#3c41c4", border: "2px solid #4c41c4" }}
          >
            Balloon 4
          </div>
        </div>
        ...
        >
          <div
            className="rnd1btnrow"
            style={{ backgroundColor: "#6fc43c", border: "2px solid #7fc43c" }}
          >
            Balloon 5
          </div>
          <div
            className="rnd1btnrow"
            style={{ backgroundColor: "#a93cc4", border: "2px solid #b93cc4" }}
          >
            Balloon 6
          </div>
        </div>
        ...
        >
          <div
            className="rnd1btnrow"
            style={{ backgroundColor: "#cac13a", border: "2px solid #dac13a" }}
          >
            Balloon 7
          </div>
          <div
            className="rnd1btnrow"
            style={{ backgroundColor: "#7d582c", border: "2px solid #8d582c" }}
          >
            Balloon 8
          </div>
        </div>
        ...
        >
          <div
            className="rnd1btnrow"
            style={{ backgroundColor: "#3aa1c1", border: "2px solid #4aa1c1" }}
          >
            Balloon 9
          </div>
          <div
            className="rnd1btnrow"
            style={{ backgroundColor: "#be8438", border: "2px solid #ce8438" }}
          >
            Balloon 10
          </div>
        </div>
